...
class OrderConformedScreen extends StatelessWidget {
...
class CheckoutCard extends StatelessWidget {
  const CheckoutCard({
    super.key,
    required this.context,this.totalPrice, this.address, this.paymentType,
  });
