                    ...
                    itemBuilder: (context, index) => Padding(
                      ...
                      child: Dismissible(
                        ...
                        onDismissed: (direction) {
                          context.read<CartBloc>().add(RemoveItemFromCart(state.products![index].id));
                        },
                        ...
                        child: CartCard(cart: state.products![index]),
                      ),
                    ),
                  ),
          ),
          bottomNavigationBar:state.itemCount>0? CheckoutCard(
            context: context,
          ):const SizedBox(),
        );
      },
          ...
          child: Column(
            ...
            children: [
              ...
              Text.rich(
                TextSpan(
                  text:
                      "\$${double.parse((cart.price! - ((cart.price! * 10) / 100)).toStringAsFixed(2))}",
            ...
            Row(
              children: [
                BlocBuilder<CartBloc, CartState>(
                  bloc: this.context.read<CartBloc>(),
                  builder: (context, state) {
                    return Expanded(
                      child: Text.rich(
                        TextSpan(
