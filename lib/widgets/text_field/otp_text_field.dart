...
class OTPTextFieldState extends State<OTPTextField> {
  ...
  Widget buildTextField(BuildContext context, int index) {
    ...
    InputBorder getBorder(Color color) {
      final colorOrError = widget.hasError ? widget.errorBorderColor : color;
        ...
        children: [
          TextField(
            ...
            decoration: InputDecoration(
              ...
              focusedBorder: getBorder(widget.focusBorderColor),
              enabledBorder: getBorder(widget.enabledBorderColor),
              disabledBorder: getBorder(widget.disabledBorderColor),
              errorBorder: getBorder(widget.errorBorderColor),
              focusedErrorBorder: getBorder(widget.errorBorderColor),
              errorText: "mfbgjkb",
            ...
            onChanged: (String str) {
              ...
              if (str.isEmpty) {
                if (index == 0) {
                  ///widget.backgroundColor  = oldBgColor??widget.backgroundColor;
                  ///setState(() {
                  ///});
          ...
          Align(
            ...
            child: Container(
              height: 1,
              alignment: Alignment.bottomCenter,
              margin: EdgeInsets.only(bottom: AppSizes.setHeight(12)),
